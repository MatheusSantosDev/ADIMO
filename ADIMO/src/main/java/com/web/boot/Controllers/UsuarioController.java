...
import com.web.boot.Model.Permissao;
import com.web.boot.Model.Usuario;
import com.web.boot.dto.RequisicaoNovoUsuario;
import com.web.boot.repositories.PermissaoRepository;
import com.web.boot.repositories.UsuarioRepository;
...
public class UsuarioController {
	...
	public ModelAndView listar() {
		...
		ModelAndView mv = new ModelAndView("atendente/usuarios/ListaDeUsuarios");
	...
	public ModelAndView criar() {
		ModelAndView mv = new ModelAndView("atendente/usuarios/CriarUsuario");
	...
	public ModelAndView edit(@PathVariable Long id, RequisicaoNovoUsuario requisicao) {
		...
		if (optional.isPresent()) {
			...
			ModelAndView mv = new ModelAndView("atendente/usuarios/EditarUsuario");
